...
function Navbar(){
    return <>
        ...
        <nav className="z-100 rounded-2xl backdrop-blur-sm flex justify-between items-center font-semibold p-5 pr-10 mx-5 top-0 left-0 sticky">
            ...
            <div className="flex gap-10 text-[20px] ">
                ...
                <Link className="hover:text-red-500 motion-preset-rebound-down motion-delay-500" to='/accounts'>Account's</Link>
